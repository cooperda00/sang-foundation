    ...
    <Fade>
      <section className={styles.Container}>
        ...
        <p>
          ...
          elderly and others affected by the decimation of the tourism industry
          in Prachauap Kirikhan and Phetchaburi.
        </p>

        <p>
          It is estimated that over a thousand families are without sufficient
          food and daily supplies in these two provinces alone. Your donation
          will go directly to feeding and supporting these vulnerable families
