      ...
      <div className={styles.Facts}>
        <Fade left>
          <div className={`${styles.Fact} ${styles.Fact1}`}>
            <Fade top>
              <h2>
                Fact 1: One of the most detrimental environmental problems in
                our world today is the tons of plastic being dumped relentlessly
                into our oceans.
              </h2>
            </Fade>
            ...
            <Fade top>
              <p>
                In July 2017, Sang foundation was invited by the UN in Bangkok
                to build a giant whale installation - to be exhibited during the
                Asian Pacific UN Ministerial Environment Summit from 5-8
                September 2017. The result was "Bobo The Whale", a concept
                created by Mutsumi Adachi. As the founder of the Sang
                Foundation, she wanted to raise awareness by displaying a whale
                with plastic debris in its belly.{" "}
              </p>
            </Fade>
            <Fade top>
              <p>
                ...
                emergency. The UN also invited the Clean Ocean Organization of
                New York to play a 4D VR video called "The Lonely Whale" at the
                summit. This VR video gave participants the experience of a
                being a whale swimming in a sea of trash. Viewers could clearly
                imagine how this magnificent whale would suffer a slow and
                painful death from ingesting plastic debris. The exhibits
                focused on the disastrous effects of ocean pollution,
                particularly around Thailand.{" "}
              </p>
            </Fade>
            <Fade top>
              <p>
          ...
          <div className={`${styles.Fact} ${styles.Fact2}`}>
            ...
            <Fade top>
              <p>
                ...
                completed after a good deal of precise concentrated efforts.
                Bobo has fins on both sides measuring around 1.5m each, and a 4
                meter-long tail stuffed with plastic bottles collected from the
                UN coffee shops and cafeteria, and from volunteers' personal
                contributions.{" "}
              </p>
            </Fade>
            <Fade top>
              <p>
                To avoid using plastic, Sang Foundation hoped to make Bobo out
                of recyclable fabric. The Trend Denim Company generously donated
                110 yards of blue denim to cover the body of the whale. Many
                volunteers from Trash Hero Hua Hin collected ocean debris from
                Pattaya. Many other volunteers and school students also helped
                to collect trash to build the exhibit.
              </p>
            </Fade>
          </div>
        </Fade>
